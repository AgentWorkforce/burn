...
use relayburn_reader::types::UserTurnBlockKind;
...
use crate::findings::{EstimatedSavings, WasteAction, WasteFinding, WasteSeverity};
...
mod tests {
    ...
    fn fixture_claude_oversized_bash_output_enriched_path() {
        use relayburn_reader::{parse_claude_session, ClaudeParseOptions};
        let pricing = load_builtin_pricing();
    ...
    fn fixture_codex_oversized_shell_output() {
        use relayburn_reader::{parse_codex_session, ParseCodexOptions};
        let pricing = load_builtin_pricing();
