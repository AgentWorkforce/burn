...
use crate::patterns::{detect_patterns, DetectPatternsOptions};
...
mod retry_loops {
    ...
    fn reports_same_retry_loop_from_event_chronology_and_annotates_event_source() {
        ...
        assert_eq!(
            g.event_source,
            Some(crate::findings::PatternEventSource::ToolResult)
        );
    ...
    fn mixes_graph_backed_with_legacy_fallback_sessions() {
        ...
        let by_session: HashMap<&str, &crate::findings::RetryLoop> = result
            .retry_loops
            .iter()
...
mod consecutive_failure_runs {
    ...
    fn counts_chained_subagent_notification_errors() {
        ...
        assert_eq!(
            ...
            Some(crate::findings::PatternEventSource::SubagentNotification)
        );
    }
}
...
mod cancelled_graph_events {
    ...
    fn keeps_cancellations_out_of_retry_failure_detectors() {
        ...
        assert_eq!(
            ...
            crate::findings::PatternEventSource::ToolResult
        );
    }
}
