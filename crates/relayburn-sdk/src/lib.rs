...
pub use crate::ingest::{
    ...
    ingest_claude_transcript_path, ingest_codex_sessions, ingest_copilot_sessions,
    ingest_opencode_sessions, start_watch_loop, write_pending_stamp, ErrorSink, IngestFn,
