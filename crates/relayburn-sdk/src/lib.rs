...
pub use crate::analyze::{
    ...
    aggregate_by_subagent, attribute_hotspots, attribute_overhead, build_trim_recommendations,
    cost_for_turn, cost_for_usage, describe_applies_to, detect_patterns,
    detect_tool_call_patterns, detect_tool_output_bloat, find_overhead_files,
    findings_from_patterns, has_minimum_fidelity, load_overhead_file, load_pricing,
    render_unified_diff_for_recommendation, summarize_fidelity, summarize_replacement_savings,
    sum_costs, AggregateByProviderOptions, AttributeOverheadInput, AttributionMethod,
    BashAggregation, BashVerbAggregation, CostBreakdown, CoverageField, FidelitySummary,
    FieldCoverage, FileAggregation, HotspotsOptions as AnalyzeHotspotsOptions,
    ...
    ProviderAggregateRow, ReasoningMode, ReplacementSavingsSummary, RowCoverage,
    SessionClaudeMdCost, SessionTotals, SubagentAggregation, ToolAttribution, TrimRecommendation,
    UsageCostAggregateRow, WasteFinding, WasteSeverity,
};
