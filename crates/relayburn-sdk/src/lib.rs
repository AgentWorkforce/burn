...
pub use crate::analyze::{
    ...
    cost_for_turn, cost_for_usage, detect_patterns, detect_tool_call_patterns,
    detect_tool_output_bloat, find_overhead_files, findings_from_patterns, has_minimum_fidelity,
    load_overhead_file, load_pricing, render_unified_diff_for_recommendation,
    ...
    ModelCost, OverheadAttribution, OverheadFile, OverheadFileAttribution, OverheadFileKind,
    ParsedOverheadFile, PricingTable, ProviderAggregateRow, ReasoningMode,
    ReplacementSavingsSummary, RowCoverage, SessionTotals, SubagentAggregation, ToolAttribution,
    TrimRecommendation, UsageCostAggregateRow, WasteFinding, WasteSeverity,
};
