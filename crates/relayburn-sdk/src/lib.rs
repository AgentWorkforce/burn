...
pub use crate::analyze::{
    ...
    attribute_hotspots, attribute_overhead, build_compare_table, build_trim_recommendations,
    compare_from_archive, cost_for_turn, cost_for_usage, detect_patterns,
    ...
    render_unified_diff_for_recommendation, summarize_fidelity, sum_costs,
    AttributeOverheadInput, AttributionMethod, BashAggregation, BashVerbAggregation,
    CompareCategory, CompareCell, CompareFromArchiveResult, CompareOptions, CompareTable,
    CompareTotals, CostBreakdown, FidelitySummary, FileAggregation,
    HotspotsOptions as AnalyzeHotspotsOptions, HotspotsResult as AnalyzeHotspotsResult, ModelCost,
    OverheadAttribution, OverheadFile, OverheadFileAttribution, OverheadFileKind,
    ParsedOverheadFile, PricingTable, ReasoningMode, SessionTotals, SubagentAggregation,
    ToolAttribution, TrimRecommendation, WasteFinding, WasteSeverity, DEFAULT_MIN_SAMPLE,
};
