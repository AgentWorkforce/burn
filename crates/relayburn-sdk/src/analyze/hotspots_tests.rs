...
use crate::reader::{
    parse_bash_command, ContentRole, ContentToolResult, SourceKind, ToolCall, Usage, UserTurnBlock,
};
use serde_json::json;
...
fn tool_result_content(session_id: &str, tool_use_id: &str, text: &str, ts: &str) -> ContentRecord {
    ContentRecord {
        v: 1,
