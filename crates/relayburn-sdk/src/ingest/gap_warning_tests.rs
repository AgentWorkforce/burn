...
// Shared with the other absorbed test modules in the same binary so
// `$RELAYBURN_HOME` mutations and gap-state mutations don't interleave.
// See note in `crate::ingest`.
use super::TEST_ENV_LOCK as ENV_LOCK;
use super::TEST_GAP_LOCK as GAP_LOCK;
