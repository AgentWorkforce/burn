...
- Licensed under Apache-2.0 (Copyright 2026 Agent Workforce Incorporated), matching Relay: added the repo `LICENSE`, set the Rust workspace `license` to `Apache-2.0`, and declared `license` on the published npm packages.
