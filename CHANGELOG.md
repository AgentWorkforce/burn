...
- `burn --json` commands now exit quietly when a downstream pipe closes early, matching human output instead of reporting the pipe closure as a generic error.
